To import initial questions, start the importer service and use swagger ui to post the initial set (see `src/main/resources/sample-data.json` in the importer service repo) to the system.
